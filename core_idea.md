...
**Entity:** Anything that has the ability to produce or consume information.

**Consumer:** Information Consumer or in short consumer is an entity which performs an input action on any information.

**Producer:** Information producer or in short producer is an entity which performs an output action of information.
