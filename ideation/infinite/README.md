...
## What is it
The system should be able to manage **Consumer**, **Producer**, **Context**. It should provide the ability to sell and buy contextual information.
...
The example of different systems that it will try to create and integrate are
